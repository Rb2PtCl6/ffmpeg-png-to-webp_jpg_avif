...
function csv(data){
	...
	fs.writeFile('img_q_webp_b.csv', csvContent, (err) => {
		if (err) throw err;
		console.log('Conversion completed. CSV file saved as img_q_webp_b.csv');
	});
}
...
fs.appendFileSync("img_q_webp_b.json",JSON.stringify(img_q))
fs.appendFileSync("img_q_keys_webp.json",JSON.stringify(img_q_keys))
